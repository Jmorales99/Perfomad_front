...
export default function LinkedInPage() {
  ...
  const { data: metrics, loading: metricsLoading, refetch: refetchMetrics } = usePlatformMetrics("linkedin")
  const { data: insights, loading: insightsLoading, refetch: refetchInsights } = usePlatformInsights("linkedin")
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-600">Métricas y insights de LinkedIn Ads</p>
          </div>
        </div>
